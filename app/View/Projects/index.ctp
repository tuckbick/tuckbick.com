<div class="projects index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('demo_url'); ?></th>
			<th><?php echo $this->Paginator->sort('src_url'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($project['Project']['demo_url']); ?>&nbsp;</td>
		<td><?php echo h($project['Project']['src_url']); ?>&nbsp;</td>
